...
using UnityEngine;
using static IntersectionsCollection.ModSettings;

namespace IntersectionsCollection
{
    public class Mod : IMod
    {
        // some extra info about this mod to show in the UI and/or the components in this mod code
        public const string MOD_NAME = "Intersections Collection";
        public static string uiHostName = "javapower-intersections-collection";
        public static readonly string Id = "IntersectionsCollection";
        ...
        public void OnLoad(UpdateSystem updateSystem)
        {
            ...
            try
            {
                ...
                AssetDatabase.global.LoadSettings(nameof(IntersectionsCollection), Settings, new ModSettings(this, false));
