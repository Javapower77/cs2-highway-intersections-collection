...
namespace IntersectionsCollection
{
    ...
    public static class LogUtil
    {
        ...
        private static readonly ILog _log = LogManager.GetLogger(Assembly.GetExecutingAssembly().GetName().ToString());
        ...
        public static void Info(string message)
        {
            ...
            Console.WriteLine($"[{Assembly.GetExecutingAssembly().GetName().ToString()}] [INFO]  {message}");
        }
